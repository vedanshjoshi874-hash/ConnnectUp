...
interface AlumniRegistrationStep1Props {
  onNext: (data: Step1FormData) => void;
  initialData?: Partial<Step1FormData>;
}

export const AlumniRegistrationStep1 = ({ onNext, initialData }: AlumniRegistrationStep1Props) => {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-2">Join as an Alumni Mentor</h1>
